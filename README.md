...
- `cloudflare:test` currently supports:
  ...
  - same-worker Durable Object enforcement prefers runtime durable-object binding metadata and excludes bindings configured with `scriptName` (remote worker designators)
