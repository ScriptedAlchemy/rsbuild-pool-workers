...
describe("defineWorkersConfig", () => {
  ...
  test("falls back to nested workers function when top-level workers is explicitly undefined", () => {
      ...
      test: {
        poolOptions: {
          workers: () => {
            ...
            return {
              main: "./src/nested-function-undefined-fallback-worker.ts",
              miniflare: {
                bindings: {
                  NESTED_FUNCTION_UNDEFINED_FALLBACK: "nested-function-undefined-fallback"
                }
              }
            };
          }
    ...
    const defineValue = value.source?.define?.__RSTEST_POOL_WORKERS_OPTIONS_JSON__;
    expect(typeof defineValue).toBe("string");
    expect(String(defineValue)).toContain("nested-function-undefined-fallback-worker.ts");
    expect(String(defineValue)).toContain("nested-function-undefined-fallback");
  ...
  test("async config function exports fall back to nested workers when top-level workers is undefined", async () => {
    const configFactory = defineWorkersConfig(async () => ({
      workers: undefined as unknown as WorkersPoolOptions,
      test: {
        poolOptions: {
          workers: {
            main: "./src/async-nested-undefined-fallback.ts",
            miniflare: {
              bindings: {
                ASYNC_UNDEFINED_FALLBACK: "async-nested-fallback"
              }
            }
          }
        }
  ...
  test("propagates rejection for async config function exports with invalid top-level workers options", async () => {
    const configFactory = defineWorkersConfig(async () => ({
  ...
  test("propagates rejection for async config function exports when nested workers function returns array", async () => {
    const configFactory = defineWorkersConfig(async () => ({
      test: {
        poolOptions: {
          workers: () => [] as unknown as WorkersPoolOptions
  ...
  test("propagates rejection for async config function exports when nested workers function returns undefined", async () => {
    const configFactory = defineWorkersConfig(async () => ({
      test: {
        poolOptions: {
          workers: () => undefined as unknown as WorkersPoolOptions
  ...
  test("propagates rejection for async config function exports when nested workers function returns null", async () => {
    const configFactory = defineWorkersConfig(async () => ({
      test: {
        poolOptions: {
  ...
  test("propagates rejection for async config function exports when nested workers function returns number", async () => {
    const configFactory = defineWorkersConfig(async () => ({
      test: {
        poolOptions: {
          workers: () => 123 as unknown as WorkersPoolOptions
  ...
  test("propagates rejection for async config function exports when top-level workers function returns null", async () => {
    const configFactory = defineWorkersConfig(async () => ({
      workers: () => null as unknown as WorkersPoolOptions
    }));
  ...
  test("propagates rejection for async config function exports when top-level workers function returns string", async () => {
    const configFactory = defineWorkersConfig(async () => ({
      workers: () => "invalid-workers-options" as unknown as WorkersPoolOptions
    }));
  ...
  test("propagates rejection for async config function exports when top-level workers function returns array", async () => {
    const configFactory = defineWorkersConfig(async () => ({
      workers: () => [] as unknown as WorkersPoolOptions
    }));
  ...
  test("propagates rejection for async config function exports when top-level workers function returns number", async () => {
    const configFactory = defineWorkersConfig(async () => ({
      workers: () => 123 as unknown as WorkersPoolOptions
    }));
  ...
  test("throws actionable error for sync config function exports with invalid nested workers options", () => {
    const configFactory = defineWorkersConfig(() => ({
      test: {
        poolOptions: {
          workers: 123 as unknown as WorkersPoolOptions
  ...
  test("throws actionable error for sync config function exports when top-level workers function returns null", () => {
    const configFactory = defineWorkersConfig(() => ({
      workers: () => null as unknown as WorkersPoolOptions
    }));
  ...
  test("throws actionable error for sync config function exports when top-level workers function returns string", () => {
    const configFactory = defineWorkersConfig(() => ({
      workers: () => "invalid-workers-options" as unknown as WorkersPoolOptions
    }));
  ...
  test("throws actionable error for sync config function exports when top-level workers function returns array", () => {
    const configFactory = defineWorkersConfig(() => ({
      workers: () => [] as unknown as WorkersPoolOptions
    }));
  ...
  test("throws actionable error for sync config function exports when top-level workers function returns number", () => {
    const configFactory = defineWorkersConfig(() => ({
      workers: () => 123 as unknown as WorkersPoolOptions
    }));
  ...
  test("throws actionable error for sync config function exports when nested workers function returns array", () => {
    const configFactory = defineWorkersConfig(() => ({
      test: {
        poolOptions: {
          workers: () => [] as unknown as WorkersPoolOptions
  ...
  test("throws actionable error for sync config function exports when nested workers function returns undefined", () => {
    const configFactory = defineWorkersConfig(() => ({
      test: {
        poolOptions: {
          workers: () => undefined as unknown as WorkersPoolOptions
  ...
  test("throws actionable error for sync config function exports when nested workers function returns null", () => {
    const configFactory = defineWorkersConfig(() => ({
      test: {
        poolOptions: {
          workers: () => null as unknown as WorkersPoolOptions
  ...
  test("throws actionable error for sync config function exports when nested workers function returns number", () => {
    const configFactory = defineWorkersConfig(() => ({
      test: {
        poolOptions: {
          workers: () => 123 as unknown as WorkersPoolOptions
  ...
  test("promise-returning config function exports fall back to nested workers when top-level workers is undefined", async () => {
    const configFactory = defineWorkersConfig(() =>
      Promise.resolve({
        workers: undefined as unknown as WorkersPoolOptions,
        test: {
          poolOptions: {
            workers: {
              main: "./src/promise-function-nested-undefined-fallback.ts",
              miniflare: {
                bindings: {
                  PROMISE_FUNCTION_UNDEFINED_FALLBACK: "promise-function-nested-fallback"
                }
              }
            }
          }
    ...
    const defineValue = resolved.source?.define?.__RSTEST_POOL_WORKERS_OPTIONS_JSON__;
    expect(typeof defineValue).toBe("string");
    expect(String(defineValue)).toContain("promise-function-nested-undefined-fallback.ts");
  ...
  test("propagates rejection for promise-returning config function exports with invalid nested workers options", async () => {
    const configFactory = defineWorkersConfig(() =>
      Promise.resolve({
        test: {
          poolOptions: {
  ...
  test("propagates rejection for promise-returning config function exports when top-level workers function returns null", async () => {
    const configFactory = defineWorkersConfig(() =>
      Promise.resolve({
        workers: () => null as unknown as WorkersPoolOptions
      })
  ...
  test("propagates rejection for promise-returning config function exports when top-level workers function returns string", async () => {
    const configFactory = defineWorkersConfig(() =>
      Promise.resolve({
        workers: () => "invalid-workers-options" as unknown as WorkersPoolOptions
      })
  ...
  test("propagates rejection for promise-returning config function exports when top-level workers function returns array", async () => {
    const configFactory = defineWorkersConfig(() =>
      Promise.resolve({
        workers: () => [] as unknown as WorkersPoolOptions
      })
  ...
  test("propagates rejection for promise-returning config function exports when top-level workers function returns number", async () => {
    const configFactory = defineWorkersConfig(() =>
      Promise.resolve({
        workers: () => 123 as unknown as WorkersPoolOptions
      })
  ...
  test("propagates rejection for promise-returning config function exports when nested workers function returns array", async () => {
    const configFactory = defineWorkersConfig(() =>
      Promise.resolve({
        test: {
          poolOptions: {
  ...
  test("propagates rejection for promise-returning config function exports when nested workers function returns undefined", async () => {
    const configFactory = defineWorkersConfig(() =>
      Promise.resolve({
        test: {
          poolOptions: {
  ...
  test("propagates rejection for promise-returning config function exports when nested workers function returns null", async () => {
    const configFactory = defineWorkersConfig(() =>
      Promise.resolve({
        test: {
          poolOptions: {
  ...
  test("propagates rejection for promise-returning config function exports when nested workers function returns number", async () => {
    const configFactory = defineWorkersConfig(() =>
      Promise.resolve({
        test: {
          poolOptions: {
  ...
  test("thenable-returning config function exports fall back to nested workers when top-level workers is undefined", async () => {
    const configFactory = defineWorkersConfig(() => {
      const value = {
        workers: undefined as unknown as WorkersPoolOptions,
        test: {
          poolOptions: {
            workers: {
              main: "./src/thenable-nested-undefined-fallback.ts",
              miniflare: {
                bindings: {
                  THENABLE_UNDEFINED_FALLBACK: "thenable-nested-fallback"
                }
              }
            }
          }
  ...
  test("propagates rejection for thenable-returning config function exports with invalid top-level workers options", async () => {
    const configFactory = defineWorkersConfig(() => {
      const value = {
        workers: 123 as unknown as WorkersPoolOptions
      };
  ...
  test("propagates rejection for thenable-returning config function exports when nested workers function returns array", async () => {
    const configFactory = defineWorkersConfig(() => {
      const value = {
        test: {
          poolOptions: {
  ...
  test("propagates rejection for thenable-returning config function exports when nested workers function returns undefined", async () => {
    const configFactory = defineWorkersConfig(() => {
      const value = {
        test: {
          poolOptions: {
  ...
  test("propagates rejection for thenable-returning config function exports when nested workers function returns null", async () => {
    const configFactory = defineWorkersConfig(() => {
      const value = {
        test: {
          poolOptions: {
  ...
  test("propagates rejection for thenable-returning config function exports when nested workers function returns number", async () => {
    const configFactory = defineWorkersConfig(() => {
      const value = {
        test: {
          poolOptions: {
  ...
  test("propagates rejection for thenable-returning config function exports when top-level workers function returns null", async () => {
    const configFactory = defineWorkersConfig(() => {
      const value = {
        workers: () => null as unknown as WorkersPoolOptions
      };
  ...
  test("propagates rejection for thenable-returning config function exports when top-level workers function returns string", async () => {
    const configFactory = defineWorkersConfig(() => {
      const value = {
        workers: () => "invalid-workers-options" as unknown as WorkersPoolOptions
      };
  ...
  test("propagates rejection for thenable-returning config function exports when top-level workers function returns array", async () => {
    const configFactory = defineWorkersConfig(() => {
      const value = {
        workers: () => [] as unknown as WorkersPoolOptions
      };
  ...
  test("propagates rejection for thenable-returning config function exports when top-level workers function returns number", async () => {
    const configFactory = defineWorkersConfig(() => {
      const value = {
        workers: () => 123 as unknown as WorkersPoolOptions
      };
  ...
  test("promise-like exports fall back to nested workers when top-level workers is undefined", async () => {
    const promiseLikeValue = {
      workers: undefined as unknown as WorkersPoolOptions,
      test: {
        poolOptions: {
          workers: {
            main: "./src/promise-like-nested-undefined-fallback.ts",
            miniflare: {
              bindings: {
                PROMISE_LIKE_UNDEFINED_FALLBACK: "promise-like-nested-fallback"
              }
            }
          }
        }
    ...
    const defineValue = resolved.source?.define?.__RSTEST_POOL_WORKERS_OPTIONS_JSON__;
    expect(typeof defineValue).toBe("string");
    expect(String(defineValue)).toContain("promise-like-nested-undefined-fallback.ts");
  ...
  test("propagates actionable error from promise-like nested workers function boolean return", async () => {
    const promiseLikeValue = {
      test: {
        poolOptions: {
          workers: () => false as unknown as WorkersPoolOptions
  ...
  test("propagates actionable error from promise-like nested workers function string return", async () => {
    const promiseLikeValue = {
      test: {
        poolOptions: {
          workers: () => "invalid-workers-options" as unknown as WorkersPoolOptions
  ...
  test("propagates actionable error from promise-like top-level workers function boolean return", async () => {
    const promiseLikeValue = {
      workers: () => false as unknown as WorkersPoolOptions
    };
    const configPromiseLike = defineWorkersConfig({
  ...
  test("propagates actionable error from promise-like top-level workers function undefined return", async () => {
    const promiseLikeValue = {
      workers: () => undefined as unknown as WorkersPoolOptions
    };
    const configPromiseLike = defineWorkersConfig({
  ...
  test("promise exports fall back to nested workers when top-level workers is undefined", async () => {
    const configPromise = defineWorkersConfig(
      Promise.resolve({
        workers: undefined as unknown as WorkersPoolOptions,
        test: {
          poolOptions: {
            workers: {
              main: "./src/promise-nested-undefined-fallback.ts",
              miniflare: {
                bindings: {
                  PROMISE_UNDEFINED_FALLBACK: "promise-nested-fallback"
                }
              }
            }
          }
  ...
  test("propagates actionable error when promise nested workers function returns a string", async () => {
    const configPromise = defineWorkersConfig(
      Promise.resolve({
        test: {
          poolOptions: {
            workers: () => "invalid-promise-nested-options" as unknown as WorkersPoolOptions
          }
        }
      })
    );
  ...
  test("propagates actionable error when promise nested workers function returns a boolean", async () => {
    const configPromise = defineWorkersConfig(
      Promise.resolve({
        test: {
          poolOptions: {
  ...
  test("propagates actionable error when promise nested workers function returns a number", async () => {
    const configPromise = defineWorkersConfig(
      Promise.resolve({
        test: {
          poolOptions: {
  ...
  test("propagates actionable error when promise nested workers function returns null", async () => {
    const configPromise = defineWorkersConfig(
      Promise.resolve({
        test: {
          poolOptions: {
  ...
  test("throws actionable error when top-level workers options is boolean", () => {
    expect(() =>
      defineWorkersConfig({
        workers: false as unknown as WorkersPoolOptions
      })
  ...
  test("throws actionable error when nested workers options is string", () => {
    expect(() =>
      defineWorkersConfig({
        test: {
          poolOptions: {
  ...
  test("defineWorkersProject falls back to nested workers function when top-level workers is explicitly undefined", () => {
    let nestedWorkersInvoked = false;
      ...
      test: {
        poolOptions: {
          workers: () => {
            nestedWorkersInvoked = true;
            return {
              main: "./src/project-nested-function-undefined-fallback-worker.ts",
              miniflare: {
                bindings: {
                  PROJECT_NESTED_FUNCTION_UNDEFINED_FALLBACK:
                    "project-nested-function-undefined-fallback"
                }
              }
            };
          }
    ...
    const defineValue = value.source?.define?.__RSTEST_POOL_WORKERS_OPTIONS_JSON__;
    expect(typeof defineValue).toBe("string");
    expect(String(defineValue)).toContain("project-nested-function-undefined-fallback-worker.ts");
    expect(String(defineValue)).toContain("project-nested-function-undefined-fallback");
    expect(nestedWorkersInvoked).toBe(true);
  });
  ...
  test("defineWorkersProject promise-like exports fall back to nested workers when top-level workers is undefined", async () => {
    const promiseLikeValue = {
      workers: undefined as unknown as WorkersPoolOptions,
      test: {
        poolOptions: {
          workers: {
            main: "./src/project-promise-like-nested-undefined-fallback.ts",
            miniflare: {
              bindings: {
                PROJECT_PROMISE_LIKE_UNDEFINED_FALLBACK: "project-promise-like-nested-fallback"
              }
            }
          }
        }
    ...
    const defineValue = resolved.source?.define?.__RSTEST_POOL_WORKERS_OPTIONS_JSON__;
    expect(typeof defineValue).toBe("string");
    expect(String(defineValue)).toContain("project-promise-like-nested-undefined-fallback.ts");
  ...
  test("defineWorkersProject propagates actionable error from promise-like nested workers function boolean return", async () => {
    const promiseLikeValue = {
      test: {
        poolOptions: {
          workers: () => false as unknown as WorkersPoolOptions
  ...
  test("defineWorkersProject propagates actionable error from promise-like nested workers function string return", async () => {
    const promiseLikeValue = {
      test: {
        poolOptions: {
          workers: () => "invalid-workers-options" as unknown as WorkersPoolOptions
  ...
  test("defineWorkersProject propagates actionable error from promise-like top-level workers function boolean return", async () => {
    const promiseLikeValue = {
      workers: () => false as unknown as WorkersPoolOptions
    };
    const value = defineWorkersProject({
  ...
  test("defineWorkersProject propagates actionable error from promise-like top-level workers function undefined return", async () => {
    const promiseLikeValue = {
      workers: () => undefined as unknown as WorkersPoolOptions
    };
    const value = defineWorkersProject({
  ...
  test("defineWorkersProject promise exports fall back to nested workers when top-level workers is undefined", async () => {
    const value = defineWorkersProject(
      Promise.resolve({
        workers: undefined as unknown as WorkersPoolOptions,
        test: {
          poolOptions: {
            workers: {
              main: "./src/project-promise-nested-undefined-fallback.ts",
              miniflare: {
                bindings: {
                  PROJECT_PROMISE_UNDEFINED_FALLBACK: "project-promise-nested-fallback"
                }
              }
            }
          }
  ...
  test("defineWorkersProject propagates actionable error when promise nested workers function returns a string", async () => {
    const value = defineWorkersProject(
      Promise.resolve({
        test: {
          poolOptions: {
            workers: () => "invalid-project-promise-nested-options" as unknown as WorkersPoolOptions
          }
        }
      })
    );
  ...
  test("defineWorkersProject propagates actionable error when promise nested workers function returns a boolean", async () => {
    const value = defineWorkersProject(
      Promise.resolve({
        test: {
          poolOptions: {
  ...
  test("defineWorkersProject propagates actionable error when promise nested workers function returns a number", async () => {
    const value = defineWorkersProject(
      Promise.resolve({
        test: {
          poolOptions: {
  ...
  test("defineWorkersProject propagates actionable error when promise nested workers function returns null", async () => {
    const value = defineWorkersProject(
      Promise.resolve({
        test: {
          poolOptions: {
  ...
  test("defineWorkersProject async config exports fall back to nested workers when top-level workers is undefined", async () => {
    const configFactory = defineWorkersProject(async () => ({
      workers: undefined as unknown as WorkersPoolOptions,
      test: {
        poolOptions: {
          workers: {
            main: "./src/project-async-nested-undefined-fallback.ts",
            miniflare: {
              bindings: {
                PROJECT_ASYNC_UNDEFINED_FALLBACK: "project-async-nested-fallback"
              }
            }
          }
        }
    ...
    const defineValue = resolved.source?.define?.__RSTEST_POOL_WORKERS_OPTIONS_JSON__;
    expect(typeof defineValue).toBe("string");
    expect(String(defineValue)).toContain("project-async-nested-undefined-fallback.ts");
  ...
  test("defineWorkersProject propagates rejection for async config function exports with invalid top-level workers options", async () => {
    const configFactory = defineWorkersProject(async () => ({
      workers: 123 as unknown as WorkersPoolOptions
    }));
  ...
  test("defineWorkersProject propagates rejection for async config function exports when nested workers function returns array", async () => {
    const configFactory = defineWorkersProject(async () => ({
      test: {
        poolOptions: {
          workers: () => [] as unknown as WorkersPoolOptions
  ...
  test("defineWorkersProject propagates rejection for async config function exports when nested workers function returns undefined", async () => {
    const configFactory = defineWorkersProject(async () => ({
      test: {
        poolOptions: {
          workers: () => undefined as unknown as WorkersPoolOptions
  ...
  test("defineWorkersProject propagates rejection for async config function exports when nested workers function returns null", async () => {
    const configFactory = defineWorkersProject(async () => ({
      test: {
        poolOptions: {
          workers: () => null as unknown as WorkersPoolOptions
  ...
  test("defineWorkersProject propagates rejection for async config function exports when nested workers function returns number", async () => {
    const configFactory = defineWorkersProject(async () => ({
      test: {
        poolOptions: {
          workers: () => 123 as unknown as WorkersPoolOptions
  ...
  test("defineWorkersProject propagates rejection for async config function exports when top-level workers function returns null", async () => {
    const configFactory = defineWorkersProject(async () => ({
      workers: () => null as unknown as WorkersPoolOptions
    }));
  ...
  test("defineWorkersProject propagates rejection for async config function exports when top-level workers function returns string", async () => {
    const configFactory = defineWorkersProject(async () => ({
      workers: () => "invalid-workers-options" as unknown as WorkersPoolOptions
    }));
  ...
  test("defineWorkersProject propagates rejection for async config function exports when top-level workers function returns array", async () => {
    const configFactory = defineWorkersProject(async () => ({
      workers: () => [] as unknown as WorkersPoolOptions
    }));
  ...
  test("defineWorkersProject propagates rejection for async config function exports when top-level workers function returns number", async () => {
    const configFactory = defineWorkersProject(async () => ({
      workers: () => 123 as unknown as WorkersPoolOptions
    }));
  ...
  test("defineWorkersProject throws actionable error for sync config function exports with invalid nested workers options", () => {
    const configFactory = defineWorkersProject(() => ({
      test: {
        poolOptions: {
          workers: 123 as unknown as WorkersPoolOptions
  ...
  test("defineWorkersProject throws actionable error for sync config function exports when top-level workers function returns null", () => {
    const configFactory = defineWorkersProject(() => ({
      workers: () => null as unknown as WorkersPoolOptions
    }));
  ...
  test("defineWorkersProject throws actionable error for sync config function exports when top-level workers function returns string", () => {
    const configFactory = defineWorkersProject(() => ({
      workers: () => "invalid-workers-options" as unknown as WorkersPoolOptions
    }));
  ...
  test("defineWorkersProject throws actionable error for sync config function exports when top-level workers function returns array", () => {
    const configFactory = defineWorkersProject(() => ({
      workers: () => [] as unknown as WorkersPoolOptions
    }));
  ...
  test("defineWorkersProject throws actionable error for sync config function exports when top-level workers function returns number", () => {
    const configFactory = defineWorkersProject(() => ({
      workers: () => 123 as unknown as WorkersPoolOptions
    }));
  ...
  test("defineWorkersProject throws actionable error for sync config function exports when nested workers function returns array", () => {
    const configFactory = defineWorkersProject(() => ({
      test: {
        poolOptions: {
          workers: () => [] as unknown as WorkersPoolOptions
  ...
  test("defineWorkersProject throws actionable error for sync config function exports when nested workers function returns undefined", () => {
    const configFactory = defineWorkersProject(() => ({
      test: {
        poolOptions: {
          workers: () => undefined as unknown as WorkersPoolOptions
  ...
  test("defineWorkersProject throws actionable error for sync config function exports when nested workers function returns null", () => {
    const configFactory = defineWorkersProject(() => ({
      test: {
        poolOptions: {
          workers: () => null as unknown as WorkersPoolOptions
  ...
  test("defineWorkersProject throws actionable error for sync config function exports when nested workers function returns number", () => {
    const configFactory = defineWorkersProject(() => ({
      test: {
        poolOptions: {
          workers: () => 123 as unknown as WorkersPoolOptions
  ...
  test("defineWorkersProject promise-returning config function exports fall back to nested workers when top-level workers is undefined", async () => {
    const configFactory = defineWorkersProject(() =>
      Promise.resolve({
        workers: undefined as unknown as WorkersPoolOptions,
        test: {
          poolOptions: {
            workers: {
              main: "./src/project-promise-function-nested-undefined-fallback.ts",
              miniflare: {
                bindings: {
                  PROJECT_PROMISE_FUNCTION_UNDEFINED_FALLBACK:
                    "project-promise-function-nested-fallback"
                }
              }
            }
          }
    ...
    expect(typeof defineValue).toBe("string");
    expect(String(defineValue)).toContain(
      "project-promise-function-nested-undefined-fallback.ts"
    );
  ...
  test("defineWorkersProject propagates rejection for promise-returning config function exports with invalid nested workers options", async () => {
    const configFactory = defineWorkersProject(() =>
      Promise.resolve({
        test: {
          poolOptions: {
  ...
  test("defineWorkersProject propagates rejection for promise-returning config function exports when top-level workers function returns null", async () => {
    const configFactory = defineWorkersProject(() =>
      Promise.resolve({
        workers: () => null as unknown as WorkersPoolOptions
      })
  ...
  test("defineWorkersProject propagates rejection for promise-returning config function exports when top-level workers function returns string", async () => {
    const configFactory = defineWorkersProject(() =>
      Promise.resolve({
        workers: () => "invalid-workers-options" as unknown as WorkersPoolOptions
      })
  ...
  test("defineWorkersProject propagates rejection for promise-returning config function exports when top-level workers function returns array", async () => {
    const configFactory = defineWorkersProject(() =>
      Promise.resolve({
        workers: () => [] as unknown as WorkersPoolOptions
      })
  ...
  test("defineWorkersProject propagates rejection for promise-returning config function exports when top-level workers function returns number", async () => {
    const configFactory = defineWorkersProject(() =>
      Promise.resolve({
        workers: () => 123 as unknown as WorkersPoolOptions
      })
  ...
  test("defineWorkersProject propagates rejection for promise-returning config function exports when nested workers function returns array", async () => {
    const configFactory = defineWorkersProject(() =>
      Promise.resolve({
        test: {
          poolOptions: {
  ...
  test("defineWorkersProject propagates rejection for promise-returning config function exports when nested workers function returns undefined", async () => {
    const configFactory = defineWorkersProject(() =>
      Promise.resolve({
        test: {
          poolOptions: {
  ...
  test("defineWorkersProject propagates rejection for promise-returning config function exports when nested workers function returns null", async () => {
    const configFactory = defineWorkersProject(() =>
      Promise.resolve({
        test: {
          poolOptions: {
  ...
  test("defineWorkersProject propagates rejection for promise-returning config function exports when nested workers function returns number", async () => {
    const configFactory = defineWorkersProject(() =>
      Promise.resolve({
        test: {
          poolOptions: {
  ...
  test("defineWorkersProject thenable-returning config function exports fall back to nested workers when top-level workers is undefined", async () => {
    const configFactory = defineWorkersProject(() => {
      const value = {
        workers: undefined as unknown as WorkersPoolOptions,
        test: {
          poolOptions: {
            workers: {
              main: "./src/project-thenable-nested-undefined-fallback.ts",
              miniflare: {
                bindings: {
                  PROJECT_THENABLE_UNDEFINED_FALLBACK: "project-thenable-nested-fallback"
                }
              }
            }
          }
  ...
  test("defineWorkersProject propagates rejection for thenable-returning config function exports with invalid top-level workers options", async () => {
    const configFactory = defineWorkersProject(() => {
      const value = {
        workers: 123 as unknown as WorkersPoolOptions
      };
  ...
  test("defineWorkersProject propagates rejection for thenable-returning config function exports when nested workers function returns array", async () => {
    const configFactory = defineWorkersProject(() => {
      const value = {
        test: {
          poolOptions: {
  ...
  test("defineWorkersProject propagates rejection for thenable-returning config function exports when nested workers function returns undefined", async () => {
    const configFactory = defineWorkersProject(() => {
      const value = {
        test: {
          poolOptions: {
  ...
  test("defineWorkersProject propagates rejection for thenable-returning config function exports when nested workers function returns null", async () => {
    const configFactory = defineWorkersProject(() => {
      const value = {
        test: {
          poolOptions: {
  ...
  test("defineWorkersProject propagates rejection for thenable-returning config function exports when nested workers function returns number", async () => {
    const configFactory = defineWorkersProject(() => {
      const value = {
        test: {
          poolOptions: {
  ...
  test("defineWorkersProject propagates rejection for thenable-returning config function exports when top-level workers function returns null", async () => {
    const configFactory = defineWorkersProject(() => {
      const value = {
        workers: () => null as unknown as WorkersPoolOptions
      };
  ...
  test("defineWorkersProject propagates rejection for thenable-returning config function exports when top-level workers function returns string", async () => {
    const configFactory = defineWorkersProject(() => {
      const value = {
        workers: () => "invalid-workers-options" as unknown as WorkersPoolOptions
      };
  ...
  test("defineWorkersProject propagates rejection for thenable-returning config function exports when top-level workers function returns array", async () => {
    const configFactory = defineWorkersProject(() => {
      const value = {
        workers: () => [] as unknown as WorkersPoolOptions
      };
  ...
  test("defineWorkersProject propagates rejection for thenable-returning config function exports when top-level workers function returns number", async () => {
    const configFactory = defineWorkersProject(() => {
      const value = {
        workers: () => 123 as unknown as WorkersPoolOptions
      };
  ...
  test("defineWorkersProject throws actionable error when top-level workers options is boolean", () => {
    expect(() =>
      defineWorkersProject({
        workers: false as unknown as WorkersPoolOptions
      })
  ...
  test("defineWorkersProject throws actionable error when nested workers options is string", () => {
    expect(() =>
      defineWorkersProject({
        test: {
          poolOptions: {
